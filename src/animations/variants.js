...
export const charItem = {
  hidden: { opacity: 0, y: 12, transition: { duration: 0.1 } },
  visible: { opacity: 1, y: 0, transition: { duration: 0.25, ease: easeOut } },
}

/* ─── Line stagger (about bio, subtitle) ────────────────────── */
export const lineContainer = {
  hidden: { opacity: 1, transition: { staggerChildren: 0.04, staggerDirection: -1 } },
  visible: {
    opacity: 1,
...
export const headingReveal = {
  hidden: { opacity: 0, clipPath: 'inset(0 100% 0 0)', transition: { duration: 0.15 } },
  visible: {
    opacity: 1,
...
export const cardContainer = {
  hidden: { opacity: 1, transition: { staggerChildren: 0.06, staggerDirection: -1 } },
  visible: {
    opacity: 1,
...
export const cardItem = {
  hidden: { opacity: 0, clipPath: 'inset(100% 0 0 0)', y: 20, transition: { duration: 0.15 } },
  visible: {
    opacity: 1,
    clipPath: 'inset(0% 0 0 0)',
    y: 0,
...
export const skillItem = {
  hidden: { opacity: 0, scale: 0.85, transition: { duration: 0.1 } },
